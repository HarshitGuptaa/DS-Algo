...
public class l001 {
	...
	public static void BFS(int src,boolean[] vis){    //deliminator method of null
	...
	public static void BFS_02(int src,boolean[] vis){ //pair class having all
		LinkedList<pair> que=new LinkedList<>();
...
public int numBusesToDestination(int[][] routes, int S, int T)
{
	...
	public static void kruskalAlgo(int[][] arr){
		// arr->[[u,v,w]]
		par=new int[arr.length+1];
		setSize = new int[arr.length+1];
		...
		ArrayList < Edge > [] KruskalGraph=new ArrayList[N];
     	for (int i = 0; i < N; i++) {
	     	KruskalGraph[i] = new ArrayList < Edge > ();
    	}
